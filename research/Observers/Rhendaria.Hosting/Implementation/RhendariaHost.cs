...
namespace Rhendaria.Hosting.Implementation
{
    public class RhendariaHost : IRhendariaHost
    {
        ...
        public RhendariaHost(IOptions<RhendariaHostOptions> hostOptions)
        {
        ...
        private ISiloHost BuildSilo()
        {
            var silo = new SiloHostBuilder()
                ...
                {
                    appParts
                        .AddApplicationPart(typeof(IMessageContainer).Assembly)
                        .AddApplicationPart(typeof(MessageContainer).Assembly);
                })
                .Build();
